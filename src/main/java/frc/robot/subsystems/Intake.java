...
public class Intake extends SubsystemBase{
    ...
    private final TalonFXS m_IntakeMotor = new TalonFXS(IntakeConstants.kIntakeMotor, CanbusName.rioCANBus);
    ...
    public Intake(){
        ...
        configs.withCurrentLimits(IntakeLimitConfigs); //Current have this commented out so that the temp current limits don't get applied
